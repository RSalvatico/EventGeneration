...
# with command line options: --python_filename N2toC1W_DRPREMIX_2018_cfg.py --eventcontent PREMIXRAW --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:N2toC1W_DRPREMIX_2018.root --pileup_input dbs:/Neutrino_E-10_gun/RunIISummer17PrePremix-PUAutumn18_102X_upgrade2018_realistic_v15-v1/GEN-SIM-DIGI-RAW --conditions 102X_upgrade2018_realistic_v15 --step DIGI,DATAMIX,L1,DIGI2RAW,HLT:@relval2018 --procModifiers premix_stage2 --geometry DB:Extended --filein file:N2toC1W_GENSIM_2018.root --datamix PreMix --era Run2_2018 --no_exec --mc -n 1
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/user/rselvati/N2toC1W_GENSIM_2018/N2toC1W_2018_v1/220314_232903/0000/N2toC1W_GENSIM_2018_1.root'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:N2toC1W_DRPREMIX_2018.root'),
    outputCommands = process.PREMIXRAWEventContent.outputCommands,
    splitLevel = cms.untracked.int32(0)
)

# Additional output definition
from N2C1_MixingModule_2018 import MixingModule
# Other statements
process.mixData.input.fileNames = cms.untracked.vstring(MixingModule)
