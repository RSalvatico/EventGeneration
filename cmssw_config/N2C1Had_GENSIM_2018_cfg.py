...
# with command line options: Configuration/GenProduction/python/SUS-RunIIFall18GS-00002-fragment_hadronic.py --python_filename N2C1Had_GENSIM_2018_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:N2C1Had_GENSIM_2018.root --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands process.source.numberEventsInLuminosityBlock = cms.untracked.uint32(200) --step GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SUS-RunIIFall18GS-00002-fragment_hadronic.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:N2C1Had_GENSIM_2018.root'),
